...
import { updateItemsAsync } from "../features/cart/cartSlice";
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-10">
        <div className="grid grid-cols-1 gap-x-8 gap-y-10 lg:grid-cols-5">
          ...
          <div className="lg:col-span-2">
            <div className="mx-auto mt-7 bg-white max-w-4xl px-4 sm:px-6 lg:px-8">
            ...
            <div className="border-t border-gray-200 px-4 py-6 sm:px-6 bg-white">
              ...
              <div className="mt-6">
                <Link
                  to="/pay"
                  className="flex items-center justify-center rounded-md border border-transparent bg-blue-800 py-3 text-white"
                >
                  Pay Now
                </Link>
              </div>
